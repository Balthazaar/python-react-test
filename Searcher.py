...
class Searcher:
	...
	def search(self,query):
		...
		#This iteration is used for ranking results	by keyword score. I am doing it on results instead of doing it  when finding matched in order to save some processing time.	
